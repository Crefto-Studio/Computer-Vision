function openCvReady() {
  ...
  //------------------------------------------------------------------- Setup
      ...
      let mask_video= document.getElementById("canvas_input");
      mask_video.style.display="none";
  //------------------------------------------------------------------ Initialization
  ...
  //------------------------------------------------------------------- Processing
      ...
      function processVideo() {
       ...
       let lower_hsv = cv.matFromArray(1, 3, cv.CV_8UC4, lower_hsv_a);
       let upper_hsv = cv.matFromArray(1, 3, cv.CV_8UC4, upper_hsv_a);
